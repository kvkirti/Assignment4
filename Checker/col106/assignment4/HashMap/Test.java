...
public class Test { 
    public static void main(String[] args) 
    {
		...
		System.out.println(count.count("snkeuodbubudhysbeoaboafjggqvamcdupoabyhwhogzghsdmijupuoawnzuccqoarihoae","oa"));
		...
		// System.out.println(hash.remove("qocbq"));
		...
		// System.out.println(hash.get("wvidq"));
		// System.out.println(hash.put("wvidq",100));
		// System.out.println(hash.get("wvidq"));
  	} 
} 
